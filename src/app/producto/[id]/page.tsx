        ...
        <div className="w-full md:w-1/2 flex flex-col">
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="text-xs text-neutral-400 font-bold hover:text-white transition-colors uppercase min-h-[48px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950">Guía de talles</button>
            </div>
